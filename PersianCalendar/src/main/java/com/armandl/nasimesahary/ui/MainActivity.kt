...
import com.armandl.nasimesahary.ReleaseDebugDifference
import com.armandl.nasimesahary.databinding.ActivityMainBinding
...
import com.armandl.nasimesahary.utils.TypefaceUtils
...
class MainActivity : DaggerAppCompatActivity(), SharedPreferences.OnSharedPreferenceChangeListener, NavigationView.OnNavigationItemSelectedListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        co.ronash.pushe.Pushe.initialize(this,true)
