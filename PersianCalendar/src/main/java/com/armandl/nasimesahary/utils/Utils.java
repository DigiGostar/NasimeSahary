package com.armandl.nasimesahary.utils;
...
import com.armandl.nasimesahary.Constants;
...
import com.armandl.nasimesahary.entities.CalendarTypeItem;
import com.armandl.nasimesahary.entities.CityItem;
import com.armandl.nasimesahary.entities.DeviceCalendarEvent;
import com.armandl.nasimesahary.entities.GregorianCalendarEvent;
import com.armandl.nasimesahary.entities.IslamicCalendarEvent;
import com.armandl.nasimesahary.entities.PersianCalendarEvent;
import com.armandl.nasimesahary.entities.ShiftWorkRecord;
import com.armandl.nasimesahary.equinox.Equinox;
import com.armandl.nasimesahary.praytimes.CalculationMethod;
import com.armandl.nasimesahary.praytimes.Clock;
import com.armandl.nasimesahary.praytimes.Coordinate;
import com.armandl.nasimesahary.praytimes.PrayTimes;
import com.armandl.nasimesahary.praytimes.PrayTimesCalculator;
import com.armandl.nasimesahary.service.ApplicationService;
import com.armandl.nasimesahary.service.AthanNotification;
import com.armandl.nasimesahary.service.BroadcastReceivers;
import com.armandl.nasimesahary.service.UpdateWorker;
import com.armandl.nasimesahary.ui.AthanActivity;
...
import static com.armandl.nasimesahary.Constants.ALARMS_BASE_ID;
import static com.armandl.nasimesahary.Constants.ARABIC_DIGITS;
import static com.armandl.nasimesahary.Constants.ARABIC_INDIC_DIGITS;
import static com.armandl.nasimesahary.Constants.BLUE_THEME;
import static com.armandl.nasimesahary.Constants.BROADCAST_ALARM;
import static com.armandl.nasimesahary.Constants.BROADCAST_RESTART_APP;
import static com.armandl.nasimesahary.Constants.BROADCAST_UPDATE_APP;
import static com.armandl.nasimesahary.Constants.CJK_DIGITS;
import static com.armandl.nasimesahary.Constants.DARK_THEME;
import static com.armandl.nasimesahary.Constants.DAYS_ICONS;
import static com.armandl.nasimesahary.Constants.DAYS_ICONS_AR;
import static com.armandl.nasimesahary.Constants.DAYS_ICONS_CKB;
import static com.armandl.nasimesahary.Constants.DEFAULT_ALTITUDE;
import static com.armandl.nasimesahary.Constants.DEFAULT_AM;
import static com.armandl.nasimesahary.Constants.DEFAULT_APP_LANGUAGE;
import static com.armandl.nasimesahary.Constants.DEFAULT_ATHAN_VOLUME;
import static com.armandl.nasimesahary.Constants.DEFAULT_CITY;
import static com.armandl.nasimesahary.Constants.DEFAULT_IRAN_TIME;
import static com.armandl.nasimesahary.Constants.DEFAULT_ISLAMIC_OFFSET;
import static com.armandl.nasimesahary.Constants.DEFAULT_LATITUDE;
import static com.armandl.nasimesahary.Constants.DEFAULT_LONGITUDE;
import static com.armandl.nasimesahary.Constants.DEFAULT_NOTIFICATION_ATHAN;
import static com.armandl.nasimesahary.Constants.DEFAULT_NOTIFY_DATE;
import static com.armandl.nasimesahary.Constants.DEFAULT_NOTIFY_DATE_LOCK_SCREEN;
import static com.armandl.nasimesahary.Constants.DEFAULT_PERSIAN_DIGITS;
import static com.armandl.nasimesahary.Constants.DEFAULT_PM;
import static com.armandl.nasimesahary.Constants.DEFAULT_PRAY_TIME_METHOD;
import static com.armandl.nasimesahary.Constants.DEFAULT_SELECTED_WIDGET_TEXT_COLOR;
import static com.armandl.nasimesahary.Constants.DEFAULT_WEEK_ENDS;
import static com.armandl.nasimesahary.Constants.DEFAULT_WEEK_START;
import static com.armandl.nasimesahary.Constants.DEFAULT_WIDGET_CLOCK;
import static com.armandl.nasimesahary.Constants.DEFAULT_WIDGET_IN_24;
import static com.armandl.nasimesahary.Constants.KEY_EXTRA_PRAYER_KEY;
import static com.armandl.nasimesahary.Constants.LANG_AR;
import static com.armandl.nasimesahary.Constants.LANG_AZB;
import static com.armandl.nasimesahary.Constants.LANG_CKB;
import static com.armandl.nasimesahary.Constants.LANG_EN_IR;
import static com.armandl.nasimesahary.Constants.LANG_EN_US;
import static com.armandl.nasimesahary.Constants.LANG_FA;
import static com.armandl.nasimesahary.Constants.LANG_FA_AF;
import static com.armandl.nasimesahary.Constants.LANG_GLK;
import static com.armandl.nasimesahary.Constants.LANG_JA;
import static com.armandl.nasimesahary.Constants.LANG_PS;
import static com.armandl.nasimesahary.Constants.LANG_UR;
import static com.armandl.nasimesahary.Constants.LIGHT_THEME;
import static com.armandl.nasimesahary.Constants.LOAD_APP_ID;
import static com.armandl.nasimesahary.Constants.MODERN_THEME;
import static com.armandl.nasimesahary.Constants.PERSIAN_DIGITS;
import static com.armandl.nasimesahary.Constants.PREF_ALTITUDE;
import static com.armandl.nasimesahary.Constants.PREF_APP_LANGUAGE;
import static com.armandl.nasimesahary.Constants.PREF_ATHAN_ALARM;
import static com.armandl.nasimesahary.Constants.PREF_ATHAN_GAP;
import static com.armandl.nasimesahary.Constants.PREF_ATHAN_URI;
import static com.armandl.nasimesahary.Constants.PREF_ATHAN_VOLUME;
import static com.armandl.nasimesahary.Constants.PREF_GEOCODED_CITYNAME;
import static com.armandl.nasimesahary.Constants.PREF_HOLIDAY_TYPES;
import static com.armandl.nasimesahary.Constants.PREF_IRAN_TIME;
import static com.armandl.nasimesahary.Constants.PREF_ISLAMIC_OFFSET;
import static com.armandl.nasimesahary.Constants.PREF_LATITUDE;
import static com.armandl.nasimesahary.Constants.PREF_LONGITUDE;
import static com.armandl.nasimesahary.Constants.PREF_MAIN_CALENDAR_KEY;
import static com.armandl.nasimesahary.Constants.PREF_NOTIFICATION_ATHAN;
import static com.armandl.nasimesahary.Constants.PREF_NOTIFY_DATE;
import static com.armandl.nasimesahary.Constants.PREF_NOTIFY_DATE_LOCK_SCREEN;
import static com.armandl.nasimesahary.Constants.PREF_OTHER_CALENDARS_KEY;
import static com.armandl.nasimesahary.Constants.PREF_PERSIAN_DIGITS;
import static com.armandl.nasimesahary.Constants.PREF_PRAY_TIME_METHOD;
import static com.armandl.nasimesahary.Constants.PREF_SELECTED_LOCATION;
import static com.armandl.nasimesahary.Constants.PREF_SELECTED_WIDGET_TEXT_COLOR;
import static com.armandl.nasimesahary.Constants.PREF_SHIFT_WORK_RECURS;
import static com.armandl.nasimesahary.Constants.PREF_SHIFT_WORK_SETTING;
import static com.armandl.nasimesahary.Constants.PREF_SHIFT_WORK_STARTING_JDN;
import static com.armandl.nasimesahary.Constants.PREF_SHOW_DEVICE_CALENDAR_EVENTS;
import static com.armandl.nasimesahary.Constants.PREF_THEME;
import static com.armandl.nasimesahary.Constants.PREF_WEEK_ENDS;
import static com.armandl.nasimesahary.Constants.PREF_WEEK_START;
import static com.armandl.nasimesahary.Constants.PREF_WIDGET_CLOCK;
import static com.armandl.nasimesahary.Constants.PREF_WIDGET_IN_24;
import static com.armandl.nasimesahary.Constants.THREE_HOURS_APP_ID;
import static com.armandl.nasimesahary.Constants.ZWJ;

//import com.armandl.nasimesahary.entities.Reminder;
...
//        sReminderDetails = updateSavedReminders(context);
    ...
    static private void loadEvents(Context context) {
        ...
        try {
            ...
            days = allTheEvents.getJSONArray("Nasime Sahary");
            length = days.length();
